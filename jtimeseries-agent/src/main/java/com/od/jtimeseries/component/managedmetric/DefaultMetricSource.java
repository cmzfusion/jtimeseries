 ...
 * created, for example
 */
public class DefaultMetricSource implements ManagedMetricSource {

    private List<ManagedMetric> metrics;

    public DefaultMetricSource(List<ManagedMetric> metrics) {
        this.metrics = metrics;
    }

    public List<ManagedMetric> getManagedMetrics() {
        return metrics;
    }
}
