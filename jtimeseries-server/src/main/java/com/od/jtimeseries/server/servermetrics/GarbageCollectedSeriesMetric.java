...
public class GarbageCollectedSeriesMetric extends ServerMetric {
    ...
    private static final String GARBAGE_COLLECTED_SERIES_COUNT_METRIC_DESC =
            "A count of the series deallocated for memory efficiency over each " + minutes + " minute period, " +
    ...
    public GarbageCollectedSeriesMetric() {
    }
    ...
    public void setupSeries(TimeSeriesContext metricContext, IdentifiableTimeSeries timeSeries) {
        ...
        DefaultTimedCapture t = new DefaultTimedCapture("Capture " + getSeriesId(), counter, timeSeries, CaptureFunctions.COUNT(Time.minutes(minutes)));
