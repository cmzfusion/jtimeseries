 ...
 */
public class MemoryCacheHitRatioMetric extends AbstractManagedMetric {

    private static final String id = "MemoryCacheHitRatio";
    private String parentContextPath;
    private TimeSeriesCache cache;
    private TimePeriod timePeriod;

    public MemoryCacheHitRatioMetric(String parentContextPath, TimeSeriesCache cache) {
        this(parentContextPath, cache, DEFAULT_TIME_PERIOD_FOR_SERVER_METRICS);
    }

    public MemoryCacheHitRatioMetric(String parentContextPath, TimeSeriesCache cache, TimePeriod timePeriod) {
