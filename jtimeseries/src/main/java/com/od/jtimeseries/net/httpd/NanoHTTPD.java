...
public class NanoHTTPD
{
    ...
    public static class NoCacheResponse extends Response {
        ...
        public NoCacheResponse() {
            setNoCacheHeaders();
        }

        public NoCacheResponse(String status, String mimeType, InputStream data) {
            super(status, mimeType, data);
            setNoCacheHeaders();
        }

        public NoCacheResponse(String status, String mimeType, String txt) {
							   ...
							   boolean allowDirectoryListing )
	{
		...
		if ( f.isDirectory())
		{
			...
			else if ( allowDirectoryListing )
			{
				...
				return new NoCacheResponse( HTTP_OK, MIME_HTML, msg );
			}
			else
			{
				return new Response( HTTP_FORBIDDEN, MIME_PLAINTEXT,
		...
		try
		{
			...
			fis.skip( startFrom );
			Response r = new NoCacheResponse( HTTP_OK, mime, fis );
