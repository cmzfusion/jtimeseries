...
public class TestTimeSeriesNaming extends TestCase {
    ...
    public void testNaming() {
        ...
        assertNotNull(rootContext.get("Login Attempts (LatestCount)"));
